...
import { LegacyAssetGrid } from "./LegacyAssetGrid";
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center space-x-4 mb-4">
                {isEditingName ? (
                  ...
                  <h1 
                    className="text-2xl font-bold cursor-pointer hover:bg-[#fcfcf0] px-2 py-1 rounded"
              ...
              <div className="flex items-center space-x-4">
                {isEditingColor ? (
                  ...
                  <div className="flex items-center space-x-2">
                    <Label className="text-sm font-medium">Brand Color:</Label>
                    <div 
                      className="w-6 h-6 rounded border border-amber-300 cursor-pointer hover:ring-2 hover:ring-amber-400"
            ...
            <div className="flex items-center space-x-2">
              <Button
                ...
                className="border-amber-200 hover:bg-[#fcfcf0] text-amber-700"
              >
